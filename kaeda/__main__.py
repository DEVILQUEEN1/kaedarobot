...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/Sur-vivor/kaeda)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/Sur-vivor/kaeda.git)
"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("kaeda.modules." + module_name)
